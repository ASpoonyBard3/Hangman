...
ColoursWords = 'red orange yellow green blue indigo violet white black brown'.split()

ShapeWords = 'square triangle rectangle circle ellipse rhombus trapezoid chevron pentagon hexagon septagon octagon'.split()

FruitWords = 'apple orange lemon lime pear watermelon grape grapefruit cherry banana cantaloupe mango strawberry tomato'.split()
